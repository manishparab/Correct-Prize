...
public class ItemWatching extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.activity_item_watching, container, false);
        mGridView = (StaggeredGridView) v.findViewById(R.id.grid_view_item_watching);
    ...
    private void PopulateData()
    {
        if (offerItems.size() ==0) {
            ...
            params.put("userId", "6");
            String url = "http://manishp.info/CPDataService.svc/GetItemsWatching";
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            try {
                                if (response != null) {
                                    ...
                                    mAdapter = new DataAdapterEsty(context, offerItems, TabType.Watching);
